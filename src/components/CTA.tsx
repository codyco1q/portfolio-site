    ...
    <section id="cta" className="py-24 px-8 relative overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
          <AuditForm />
          <div className="flex flex-col justify-center gap-4 order-first md:order-last">
            <p className="text-sm text-zinc-400 leading-relaxed">
              Not ready to hop on a call? Grab a{' '}
              <span className="text-white font-medium">free automation audit</span> instead. Tell me
              where things are stuck and I&rsquo;ll map the fixes.
            </p>
            <ul className="space-y-2.5">
              {[
                'Bottleneck analysis of your current funnel & CRM',
                'Priority list of automations with the biggest ROI',
                'No commitment — just a clear roadmap',
              ].map((item) => (
