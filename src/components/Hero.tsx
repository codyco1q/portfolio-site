    ...
    <section className="relative flex flex-col items-center justify-center min-h-screen px-8 text-center overflow-hidden">
      ...
      <div className="relative">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-zinc-500/20 bg-zinc-900/50 backdrop-blur-sm text-zinc-400 text-xs mb-8">
          ...
          AI Automation & Funnel Engineering
        </div>
        <h1 className="text-5xl md:text-7xl font-bold tracking-tighter leading-tight mb-6">
          <span className="text-white">Autonomous Systems.</span><br />
          <span className="bg-gradient-to-r from-zinc-200 via-white to-zinc-400 bg-clip-text text-transparent">
            Infinite Scalability.
          </span>
        </h1>
        <p className="text-lg text-zinc-400 max-w-xl mx-auto mb-10 leading-relaxed">
          I architect AI-powered voice agents, multi-platform automation engines, and high-converting sales funnels that run without you.
        </p>
